...
class Images(object):
    def __init__(self, setting, pair_info, stage, fixed_im_sitk=None, moved_im_affine_sitk=None, fixed_mask_sitk=None,
        ...
        self._fixed_landmarks_index_padded = None
        self._moving_landmarks_world = None
        self._fixed_after_affine_landmarks_world = None
        ...
        self._sweep_dim_completed = np.array([0, 0, 0])
