...
def initialize_setting(current_experiment, where_to_run=None):
    ...
    setting['stage'] = 1
    setting['UseLungMask'] = True
    setting['UseTorsoMask'] = True
    setting['verbose_image'] = False
...
def root_address_generator(where_to_run='Auto'):
    ...
    if where_to_run == 'Root':
        ...
        root_folder = '/exports/lkeb-hpc/Project/DL/'
        data_folder = '/exports/lkeb-hpc/Data/'
    else:
...
def load_data_setting(selected_data):
    ...
    if selected_data == 'SPREAD':
        ...
        data_setting['ImageByte'] = 2
        data_setting['types'] = ['Fixed', 'Moving']
        data_setting['expPrefix'] = 'ExpLung'
        data_setting['DefaultPixelValue'] = -2048
        ...
        data_setting['ext'] = '.mha'
        data_setting['ImageByte'] = 2
        data_setting['types'] = ['T00', 'T10', 'T20', 'T30', 'T40', 'T50', 'T60', 'T70', 'T80', 'T90']
        data_setting['expPrefix'] = 'case'
        data_setting['DefaultPixelValue'] = -2048
        data_setting['VoxelSize'] = [1, 1, 1]
        data_setting['AffineRegistration'] = True
        ...
        data_setting['ext'] = '.mha'
        data_setting['ImageByte'] = 2
        data_setting['types'] = ['iBHCT', 'eBHCT']
        data_setting['expPrefix'] = 'copd'
        data_setting['DefaultPixelValue'] = -2048
        data_setting['VoxelSize'] = [1, 1, 1]
        data_setting['AffineRegistration'] = True
        data_setting['UnsureLandmarkAvailable'] = False
