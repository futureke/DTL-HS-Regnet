...
def load_deform_exp_setting(selected_deform_exp):
    ...
    if selected_deform_exp == '3D_max20_D14':
        ...
        # Mixed Frequency
        def_setting['MixedFrequency_BlockRadius'] = 20
