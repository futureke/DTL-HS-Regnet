...
def job_script(setting, job_name=None, script_address=None, job_output_file=None):
    ...
    if setting['force_to_only_generate_images'] and setting['MainScript'] in ['RegNet.py', 'RegNet_Error.py']:
        text = text + '--only_generate_image True '
    if setting['force_to_only_generate_image_for_registration'] and setting['MainScript'] in ['RegNet_Error.py']:
        text = text + '--only_generate_image_for_registration True '
    if setting['force_to_never_generate_image'] and setting['MainScript'] in ['RegNet.py', 'RegNet_Error.py']:
